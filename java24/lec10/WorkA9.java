...
public class WorkA9 {
  public static void main(String[] args) {
    ...
    if (n > 0) {
      ...
      sc.close();
      Arrays.sort(itemList, (item1, item2) -> item2.calcTotalPrice() - item1.calcTotalPrice());
  ...
  private static ItemA8 inputItemData(Scanner sc) {
    ...
    if (itemCode.charAt(0) == 'S') {
      SpecialItemA9 item = new SpecialItemA9(itemCode, price, num);
      System.out.println("割引率を入力してください");
